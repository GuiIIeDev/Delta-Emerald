...
//
static const u8 sText_DexNum[] = _("{POKE}dex: {STR_VAR_1}");
static const u8 sText_Badges[] = _("Badges:  {STR_VAR_1}");
static void PrintToWindow(u8 windowId, u8 colorIdx)
{
    const u8 colors[3] = {TEXT_COLOR_TRANSPARENT, TEXT_COLOR_WHITE, TEXT_COLOR_LIGHT_GRAY}; 
    ...
    *playTimePtr = 0xF0;
    ...
    if (FlagGet(FLAG_SYS_POKEDEX_GET) == TRUE)
    {
        ...
        ConvertIntToDecimalStringN(gStringVar1, dexCount, STR_CONV_MODE_RIGHT_ALIGN, 3);
    ...
    ConvertIntToDecimalStringN(gStringVar1, badgeCount, STR_CONV_MODE_RIGHT_ALIGN, 2);
