...
{
    [MENUITEM_GENERAL_TEXTSPEED]    = {TextSpeed_DrawChoices,     ThreeOptions_ProcessInput},
...
{
    [MENUITEM_GENERAL_TEXTSPEED]   = {sText_Desc_TextSpeed,            sText_Desc_TextSpeed,            sText_Desc_TextSpeed},
...
static void TextSpeed_DrawChoices(int selection, int y)
{
    ...
    DrawOptionMenuChoice(gText_TextSpeedFast, GetStringRightAlignXOffset(FONT_NORMAL, gText_BattleSceneOff, 198), y, styles[2], active);
}
